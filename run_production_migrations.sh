...
# Скрипт для запуска миграций на продакшене
# Автор: AI Assistant
# Дата: $(date +"%Y-%m-%d %H:%M:%S")

set -e

echo "🔄 Запуск миграций базы данных на продакшене"
echo "=============================================="
...
SELECT 
    ...
    tableowner
FROM pg_tables 
WHERE tablename IN ('roles', 'permissions', 'role_permissions', 'user_templates', 'users')
