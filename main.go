...
func main() {
	...
	apiGroup.POST("/skif/connections/:id/sync-users", api.SyncSkifUsers)
	apiGroup.POST("/skif/connections/:id/users", api.CreateSkifUser)
	apiGroup.PUT("/skif/connections/:id/users/:userId", api.UpdateSkifUser)
	apiGroup.DELETE("/skif/connections/:id/users/:userId", api.DeleteSkifUser)
	apiGroup.GET("/skif/connections/:id/companies", api.GetSkifConnectionCompanies)
	...
	apiGroup.POST("/skif/connections/:id/sync-statuses", api.SyncSkifStatuses)
	apiGroup.POST("/skif/connections/:id/subdealers", api.CreateSkifSubdealer)
	apiGroup.POST("/skif/connections/:id/sync-subdealers", api.SyncSkifSubdealers)
	apiGroup.POST("/skif/connections/:id/backfill-created", api.BackfillSkifObjectCreated)
